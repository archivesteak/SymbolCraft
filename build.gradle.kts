...
gradlePlugin {
    ...
    plugins {
        ...
        create("symbolcraftCompose") {
            id = "io.github.archivesteak.symbolcraft.compose"
            implementationClass =
                "io.github.archivesteak.symbolcraft.plugin.SymbolCraftComposePlugin"
            displayName = "SymbolCraft - Compose consumer"
            description = "Compile the Compose sources generated by a SymbolCraft producer project."
            tags = listOf("KMP", "Compose-Multiplatform", "icons", "symbols")
        }
        create("symbolcraftApple") {
            id = "io.github.archivesteak.symbolcraft.apple"
            implementationClass = "io.github.archivesteak.symbolcraft.plugin.SymbolCraftApplePlugin"
            displayName = "SymbolCraft - Apple consumer"
            description =
                "Embed the SF Symbol catalog generated by a SymbolCraft producer project into the Xcode build."
            tags = listOf("KMP", "SwiftUI", "icons", "symbols")
        }
    }
}
