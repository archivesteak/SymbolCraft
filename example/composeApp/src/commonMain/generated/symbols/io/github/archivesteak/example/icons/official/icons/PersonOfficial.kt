...
public val Icons.PersonOfficial: ImageVector
    get() {
        ...
        _personOfficial = Builder(name = "PersonOfficial", defaultWidth = 48.0.dp, defaultHeight = 48.0.dp, viewportWidth = 960.0f, viewportHeight = 960.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                ...
                verticalLineToRelative(34.0f)
                close()
                moveTo(544.5f, 393.5f)
                quadTo(570.0f, 368.0f, 570.0f, 329.0f)
                reflectiveQuadToRelative(-25.5f, -64.5f)
                quadTo(519.0f, 239.0f, 480.0f, 239.0f)
                reflectiveQuadToRelative(-64.5f, 25.5f)
                quadTo(390.0f, 290.0f, 390.0f, 329.0f)
                reflectiveQuadToRelative(25.5f, 64.5f)
                quadTo(441.0f, 419.0f, 480.0f, 419.0f)
                reflectiveQuadToRelative(64.5f, -25.5f)
                close()
