...
public val Icons.SearchFill: ImageVector
    get() {
        if (_searchFill != null) {
            return _searchFill!!
        }
        _searchFill = Builder(name = "SearchFill", defaultWidth = 48.0.dp, defaultHeight = 48.0.dp, viewportWidth = 960.0f, viewportHeight = 960.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                ...
                lineToRelative(242.0f, 240.0f)
                quadToRelative(9.0f, 8.56f, 9.0f, 21.78f)
                reflectiveQuadTo(818.0f, 817.0f)
                quadToRelative(-9.0f, 9.0f, -22.22f, 9.0f)
                quadToRelative(-13.22f, 0.0f, -21.78f, -9.0f)
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Icons.SearchFill, contentDescription = "")
    }
}
