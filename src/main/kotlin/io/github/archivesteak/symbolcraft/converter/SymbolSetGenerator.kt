...
class SymbolSetGenerator(private val logger: (String) -> Unit = {}) {
    ...
    fun generateSwiftEnumFile(symbolSetNames: List<String>, outputDirectory: File): File {
        val cases =
        ...
        val content = buildString {
            append("// Generated by SymbolCraft\n")
    ...
    /**
     * Replicates the temp file naming of the download phase
     * ([io.github.archivesteak.symbolcraft.tasks.internal.DownloadCoordinator]) so configs can be
     * matched back to their downloaded SVG.
     */
    private fun tempSvgFileName(iconName: String, config: IconConfig): String {
